...
@implementation PIODelegateViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([[segue identifier] isEqualToString:@"showOnMap"]) {
        ...
        EventViaDelegate *event = (EventViaDelegate *) [[self fetchedResultsController] objectAtIndexPath:indexPath];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self configureCell:cell withEvent:(EventViaDelegate *)object];
    return cell;
}
...
- (NSFetchedResultsController *)fetchedResultsController {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"EventViaDelegate" inManagedObjectContext:self.managedObjectContext];
...
- (void)controller:(NSFetchedResultsController *)controller didChangeObject:(id)anObject
    ...
    switch(type) {
        ...
        case NSFetchedResultsChangeUpdate:
            [self configureCell:[tableView cellForRowAtIndexPath:indexPath] withEvent:(EventViaDelegate *)anObject];
            break;
