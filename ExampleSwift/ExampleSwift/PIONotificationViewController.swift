...
class PIONotificationViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let event = fetchedResultsController.object(at: indexPath) as! EventViaNotification
    ...
    var fetchedResultsController: NSFetchedResultsController {
        ...
        let entity = NSEntityDescription.entity(forEntityName: "EventViaNotification", in: managedObjectContext)
