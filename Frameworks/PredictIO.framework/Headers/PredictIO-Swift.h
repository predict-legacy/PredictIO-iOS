...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PredictIO",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
typedef SWIFT_ENUM(NSInteger, PredictIOError, closed) {
...
typedef SWIFT_ENUM(NSInteger, PredictIOPowerLevel, closed) {
...
typedef SWIFT_ENUM(NSInteger, PredictIOTripEventType, closed) {
